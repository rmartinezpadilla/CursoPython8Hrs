## En esta practica intentaremos insertar varios registros a la vez
...
miConexion = sqlite3.connect("SegundaBaseDeDatos")
...
try:
    ...
    print(f'La base de datos esta creada, ya existe, insertando datos')
#else:  
 ...
 #   miPuntero.execute("INSERT INTO PRODUCTOS VALUES('BALÓN', 15000, 'DEPORTES')")
    ...
    miPuntero.executemany("INSERT INTO PRODUCTOS VALUES(?,?,?)", diferentes_productos)
    miConexion.commit()
