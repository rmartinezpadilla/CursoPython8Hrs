...
def crear_contraseña_random(num):
    ...
    return contraseña,num, numero_dado
    
#desempaquetando la funciòn
password,primer_numero, numero_dado = crear_contraseña_random(981)
...
print(f"El nùmero completo dado para crearla fue: {numero_dado}")