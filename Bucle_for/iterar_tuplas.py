...
#recorriendo la tupla de animales
for animal in animales:
    print(animal)
    print(f'ahora la variable tiene el valor de: {animal}')
    
#recorriendo la tupla de numeros
for numero in numeros:
    resultado = numero * 3
    print(resultado)

#recorriendo ambas tupla usando la función zip()
for animal, numero in zip(animales, numeros):
    print(animal)
    print(numero)
    
#forma correcta de recorrer una tupla con su indice
