#encontrar los números primos hasta el valor que el usuario le ordene

def numeros_primos_hasta(valor):
    primos = []
    veces =  valor
    for item in range(2, veces):
        if veces%item==0:        
            primos.append(item)
    return primos
         
resultado = numeros_primos_hasta(13)
print(resultado)
